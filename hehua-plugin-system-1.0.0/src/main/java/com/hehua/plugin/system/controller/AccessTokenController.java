...
public class AccessTokenController {
    ...
    @RequestMapping("/accessToken.data")
    public HttpEntity token(HttpServletRequest request)throws URISyntaxException, OAuthSystemException {
        ...
        try {
            ...
            OAuthResponse response = OAuthASResponse
                    ...
                    .buildJSONMessage();
            String bs =response.getBody();
            //根据OAuthResponse生成ResponseEntity
            return new ResponseEntity(JSONUtils.parseJSON(bs), HttpStatus.valueOf(response.getResponseStatus()));
