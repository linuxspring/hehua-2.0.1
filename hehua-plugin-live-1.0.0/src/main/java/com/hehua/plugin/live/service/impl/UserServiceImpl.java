package com.hehua.plugin.user.service.impl;

import com.baomidou.mybatisplus.plugins.Page;
import com.baomidou.mybatisplus.service.impl.ServiceImpl;
import com.hehua.plugin.user.entity.User;
import com.hehua.plugin.user.mapper.UserMapper;
...
import java.sql.Connection;
        ...
        import com.baomidou.mybatisplus.plugins.Page;
        import com.baomidou.mybatisplus.service.impl.ServiceImpl;
        import com.gzcss.weixin.model.Plat_Menu;
        import com.gzcss.weixin.model.Plat_Role;
        import com.gzcss.weixin.model.Plat_Rule;
        import org.apache.ibatis.session.SqlSession;
        import org.apache.ibatis.session.SqlSessionFactory;
        ...
        import com.gzcss.city.entity.Operator;
        import com.gzcss.util.PropertiesUtil;
        import com.gzcss.weixin.mapper.UserMapper;
        import com.gzcss.weixin.model.Plat_User;

        import net.biz.plugins.utils.EventOrder;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, Plat_User> {
    ...
    public Plat_User findByAccount(String account) {
        ...
        Plat_User user = sqlSession.selectOne("");// this.baseMapper.findByAccount(account);
    ...
    public String getAcountByMapUserName(String username) {
        //SqlSession sqlSession = sqlSessionFactory.openSession();
        String user = this.getSession().selectOne("com.gzcss.weixin.mapper.UserMapper.getAcountByMapUserName", username);// this.baseMapper.findByAccount(account);
        return user;
    }

    public String getQixinAcountByUserName(String username) {
        //SqlSession sqlSession = sqlSessionFactory.openSession();
        String user = this.getSession().selectOne("com.gzcss.weixin.mapper.UserMapper.getQixinAcountByUserName", username);// this.baseMapper.findByAccount(account);
        return user;
    }
    ...
    public List<Map<String, String>> getQixinAcountByUserNames(List<String> usernames) {
        ...
        List<Map<String, String>> users = this.getSession().selectList("com.gzcss.weixin.mapper.UserMapper.getQixinAcountByUserNames", params);// this.baseMapper.findByAccount(account);
        return users;
    }
    ...
    public String getItsmUserNameByTel(String tel) {
        ...
        String user=null;
        if ("030500".equals(PropertiesUtil.getProperty("config.cityCode"))) {
            user = this.getSession().selectOne("com.gzcss.weixin.mapper.UserMapper.getZngkUserNameByName", tel);
        }else{
            user = this.getSession().selectOne("com.gzcss.weixin.mapper.UserMapper.getItsmUserNameByTel", tel);// this.baseMapper.findByAccount(account);
        }
        return user;
    }
    ...
    public int addUserNameToQixin(String itsm_username, String qixinUserId) {
        ...
        int user = this.getSession().insert("com.gzcss.weixin.mapper.UserMapper.addUserNameToQixin", params);// this.baseMapper.findByAccount(account);
        return user;
    }
    ...
    public AjaxJson getEventOrderStatus(String orderNo, String username) {
        ...
        List<Map<String, String>> user = this.getSession().selectList("com.gzcss.weixin.mapper.UserMapper.getEventOrderStatus",
    ...
    public Operator getOrderOwnerInfo(String orderNo) {
        AjaxJson ajaxJson = new AjaxJson();
        //SqlSession sqlSession = sqlSessionFactory.openSession();
        Map<String, Object> user = this.getSession().selectOne("com.gzcss.weixin.mapper.UserMapper.getOrderOwnerInfo",
    ...
    public Map<String, Object> getOrderCurrentInfo(String orderNo) {
        AjaxJson ajaxJson = new AjaxJson();
        //SqlSession sqlSession = sqlSessionFactory.openSession();
        Map<String, Object> user = this.getSession().selectOne("com.gzcss.weixin.mapper.UserMapper.getOrderCurrentInfo", orderNo);// this.baseMapper.findByAccount(account);
//        oper.setIsAccept(rs.getString("ISJIESHOU"));
//        oper.setIsAssignment(rs.getString("ISFENPA"));
//        oper.setCss_status(rs.getString("CSS_STATUS"));
        Operator oper = new Operator();
    ...
    public Map<String, Object> getPleaseOrderCurrentInfo(String orderNo, String username) {
        ...
        Map<String, Object> user = this.getSession().selectOne("com.gzcss.weixin.mapper.UserMapper.getPleaseOrderCurrentInfo", parms);
        if (user == null) {
    ...
    public int getocmqUpdatePleaseOrder(String orderNo, String value) {
        ...
        int user = this.getSession().update("com.gzcss.weixin.mapper.UserMapper.ocmqUpdate", ajaxJson);
        return user;
    }
    ...
    public String accept(String usernameId, String number, String status) {
        AjaxJson ajaxJson = new AjaxJson();
        //SqlSession sqlSession = sqlSessionFactory.openSession();
        Map<String, Object> user = this.getSession().selectOne("com.gzcss.weixin.mapper.UserMapper.accept", number);
        // oper.setIsAccept(rs.getString("ISJIESHOU"));
        // oper.setIsAssignment(rs.getString("ISFENPA"));
        // oper.setCss_status(rs.getString("CSS_STATUS"));
        return number;
    ...
    public String getList(int page, int size) {
        ...
        List<Plat_User> result = sqlSession.selectList("com.gzcss.weixin.mapper.UserMapper.getList", Plat_User.class);

        int count;
        try {
            count = sqlSession.selectOne("com.gzcss.weixin.mapper.UserMapper.countUser");
    ...
    public int doorToDoor(String number, String datetime) {
        ...
        int result = this.getSession().update("com.gzcss.weixin.mapper.UserMapper.doorToDoor", params);
        return result;
    }
    ...
    public String saveSurvey(JSONObject obj) {
        ...
        try {
            ...
            String isHasCommit = this.getSession().selectOne("com.gzcss.weixin.mapper.UserMapper.getSurveyResult",
                    obj.get("incident_id"));
            ...
            if (!surveyResult) {
                ...
                int isSucc = this.getSession().update("com.gzcss.weixin.mapper.UserMapper.updateClientSurvey", params);
                if (isSucc == 0) {
                ...
                int isSuccIncident = this.getSession().update("com.gzcss.weixin.mapper.UserMapper.updateIncident", paramMap);
    ...
    public AjaxJson getSurveyHead(String incident_id) {
        ...
        //SqlSession sqlSession = sqlSessionFactory.openSession();
        Map<String, Object> list = this.getSession().selectOne("com.gzcss.weixin.mapper.UserMapper.getSurveyHead", paramMap);
        AjaxJson ajaxJson = new AjaxJson();
