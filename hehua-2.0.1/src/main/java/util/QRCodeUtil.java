 ...
 * @author pengguojin
 * @desc 二维码生成代码
 * @createtime 2017年12月6日 上午11:32:56
 * @project ITSM工程
 */
...
public class QRCodeUtil {
	...
	public static void main(String[] args) {
		...
		try {
			QRCodeUtil.encode(text, "D:/eclipse-workspace/wechat-maven/src/main/webapp/images/tag4.png", "d:/MyWorkDoc",
					true);
		} catch (Exception e) {
			e.printStackTrace();
		}
