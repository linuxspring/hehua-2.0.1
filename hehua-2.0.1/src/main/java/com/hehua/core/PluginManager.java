...
public class PluginManager {
    ...
    static {
        ...
        springIOCAnnotations.add(RestController.class);
            ...
            try {
                ...
                for (Class springIOCAnnotationClass : springIOCAnnotations) {
                    if (c.getAnnotation(springIOCAnnotationClass) != null) {
                        ...
                        definitionRegistry.registerBeanDefinition(className, BeanDefinitionBuilder.genericBeanDefinition(c).getBeanDefinition());
                        break;
                    }
                }
