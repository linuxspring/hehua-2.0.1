...
//
//    // mapper 的xml存放路径
//    protected final static String MAPPER_XML_AREA = "classpath:com/pinyi/plugin/devastate/user/mapper/*.xml";
//    // mapper.java 存放路径，被@MapperScan扫描的，注入 sqlsession的
//    protected final static String MAPPER_PACKAGE = "com.pinyi.plugin.devastate.user.mapper";
//
